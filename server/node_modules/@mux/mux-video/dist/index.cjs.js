"use strict";var Wt=Object.defineProperty;var hi=Object.getOwnPropertyDescriptor;var li=Object.getOwnPropertyNames;var fi=Object.getPrototypeOf,mi=Object.prototype.hasOwnProperty;var pi=Reflect.get;var Re=e=>{throw TypeError(e)};var gi=(e,i,t)=>i in e?Wt(e,i,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[i]=t;var Ei=(e,i)=>{for(var t in i)Wt(e,t,{get:i[t],enumerable:!0})},Ti=(e,i,t,s)=>{if(i&&typeof i=="object"||typeof i=="function")for(let n of li(i))!mi.call(e,n)&&n!==t&&Wt(e,n,{get:()=>i[n],enumerable:!(s=hi(i,n))||s.enumerable});return e};var bi=e=>Ti(Wt({},"__esModule",{value:!0}),e);var E=(e,i,t)=>gi(e,typeof i!="symbol"?i+"":i,t),ce=(e,i,t)=>i.has(e)||Re("Cannot "+t);var r=(e,i,t)=>(ce(e,i,"read from private field"),t?t.call(e):i.get(e)),l=(e,i,t)=>i.has(e)?Re("Cannot add the same private member more than once"):i instanceof WeakSet?i.add(e):i.set(e,t),u=(e,i,t,s)=>(ce(e,i,"write to private field"),s?s.call(e,t):i.set(e,t),t),y=(e,i,t)=>(ce(e,i,"access private method"),t);var $t=(e,i,t)=>pi(fi(e),t,i);var Vi={};Ei(Vi,{Attributes:()=>o,MediaError:()=>p.MediaError,VideoEvents:()=>me,default:()=>Di,generatePlayerInitTime:()=>p.generatePlayerInitTime,playerSoftwareName:()=>Ae,playerSoftwareVersion:()=>ye});module.exports=bi(Vi);var Et=class{addEventListener(){}removeEventListener(){}dispatchEvent(i){return!0}};if(typeof DocumentFragment=="undefined"){class e extends Et{}globalThis.DocumentFragment=e}var Mt=class extends Et{},ue=class extends Et{},vi={get(e){},define(e,i,t){},getName(e){return null},upgrade(e){},whenDefined(e){return Promise.resolve(Mt)}},wt,he=class{constructor(i,t={}){l(this,wt);u(this,wt,t==null?void 0:t.detail)}get detail(){return r(this,wt)}initCustomEvent(){}};wt=new WeakMap;function yi(e,i){return new Mt}var Ce={document:{createElement:yi},DocumentFragment,customElements:vi,CustomEvent:he,EventTarget:Et,HTMLElement:Mt,HTMLVideoElement:ue},_e=typeof window=="undefined"||typeof globalThis.customElements=="undefined",zt=_e?Ce:globalThis,Bi=_e?Ce.document:globalThis.document;var p=require("@mux/playback-core");var Ai=()=>{try{return"0.25.3"}catch{}return"UNKNOWN"},ki=Ai(),Ie=()=>ki;var me=["abort","canplay","canplaythrough","durationchange","emptied","encrypted","ended","error","loadeddata","loadedmetadata","loadstart","pause","play","playing","progress","ratechange","seeked","seeking","stalled","suspend","timeupdate","volumechange","waiting","waitingforkey","resize","enterpictureinpicture","leavepictureinpicture","webkitbeginfullscreen","webkitendfullscreen","webkitpresentationmodechanged"],Le=["autopictureinpicture","disablepictureinpicture","disableremoteplayback","autoplay","controls","controlslist","crossorigin","loop","muted","playsinline","poster","preload","src"];function Si(e){return`
    <style>
      :host {
        display: inline-flex;
        line-height: 0;
  ...
  `}function Ri(e){return`
    ...
    <slot></slot>
  `}function De(e,{tag:i,is:t}){var h,m,d,b,x,Me,st,a,g,_,S,at,le,we,fe,xe,Ne;let s=(m=(h=globalThis.document)==null?void 0:h.createElement)==null?void 0:m.call(h,i,{is:t}),n=s?Ci(s):[];return d=class extends e{constructor(){super(...arguments);l(this,S);l(this,st,!1);l(this,a,null);l(this,g,new Map);l(this,_);E(this,"get");E(this,"set");E(this,"call")}static get observedAttributes(){var T,P,R;return y(T=d,x,Me).call(T),[...(R=(P=s==null?void 0:s.constructor)==null?void 0:P.observedAttributes)!=null?R:[],...Le]}get nativeEl(){var f,T,P,R,k;return y(this,S,at).call(this),(k=(R=(T=(f=r(this,a))!=null?f:this.querySelector(":scope > [slot=media]"))!=null?T:this.querySelector(i))!=null?R:(P=this.shadowRoot)==null?void 0:P.querySelector(i))!=null?k:null}set nativeEl(f){u(this,a,f)}get defaultMuted(){return this.hasAttribute("muted")}set defaultMuted(f){this.toggleAttribute("muted",f)}get src(){return this.getAttribute("src")}set src(f){this.setAttribute("src",`${f}`)}get preload(){var f,T;return(T=this.getAttribute("preload"))!=null?T:(f=this.nativeEl)==null?void 0:f.preload}set preload(f){this.setAttribute("preload",`${f}`)}init(){if(!this.shadowRoot){this.attachShadow({mode:"open"});let f=_i(this.attributes);t&&(f.is=t),i&&(f.part=i),this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(f)}this.nativeEl.muted=this.hasAttribute("muted");for(let f of n)y(this,S,xe).call(this,f);u(this,_,new MutationObserver(y(this,S,we).bind(this))),this.shadowRoot.addEventListener("slotchange",()=>y(this,S,le).call(this)),y(this,S,le).call(this);for(let f of this.constructor.Events)this.shadowRoot.addEventListener(f,this,!0)}handleEvent(f){f.target===this.nativeEl&&this.dispatchEvent(new CustomEvent(f.type,{detail:f.detail}))}attributeChangedCallback(f,T,P){y(this,S,at).call(this),y(this,S,Ne).call(this,f,T,P)}connectedCallback(){y(this,S,at).call(this)}},b=new WeakMap,x=new WeakSet,Me=function(){if(r(this,b))return;u(this,b,!0);let f=new Set(this.observedAttributes);f.delete("muted");for(let T of n)if(!(T in this.prototype))if(typeof s[T]=="function")this.prototype[T]=function(...P){return y(this,S,at).call(this),(()=>{var O;if(this.call)return this.call(T,...P);let k=(O=this.nativeEl)==null?void 0:O[T];return k==null?void 0:k.apply(this.nativeEl,P)})()};else{let P={get(){var k,O,Lt;y(this,S,at).call(this);let R=T.toLowerCase();if(f.has(R)){let gt=this.getAttribute(R);return gt===null?!1:gt===""?!0:gt}return(Lt=(k=this.get)==null?void 0:k.call(this,T))!=null?Lt:(O=this.nativeEl)==null?void 0:O[T]}};T!==T.toUpperCase()&&(P.set=function(R){y(this,S,at).call(this);let k=T.toLowerCase();if(f.has(k)){R===!0||R===!1||R==null?this.toggleAttribute(k,!!R):this.setAttribute(k,R);return}if(this.set){this.set(T,R);return}this.nativeEl&&(this.nativeEl[T]=R)}),Object.defineProperty(this.prototype,T,P)}},st=new WeakMap,a=new WeakMap,g=new WeakMap,_=new WeakMap,S=new WeakSet,at=function(){r(this,st)||(u(this,st,!0),this.init())},le=function(){var R;let f=new Map(r(this,g)),T=(R=this.shadowRoot)==null?void 0:R.querySelector("slot:not([name])");(T==null?void 0:T.assignedElements({flatten:!0}).filter(k=>["track","source"].includes(k.localName))).forEach(k=>{var Lt,gt;f.delete(k);let O=r(this,g).get(k);O||(O=k.cloneNode(),r(this,g).set(k,O),(Lt=r(this,_))==null||Lt.observe(k,{attributes:!0})),(gt=this.nativeEl)==null||gt.append(O),y(this,S,fe).call(this,O)}),f.forEach((k,O)=>{k.remove(),r(this,g).delete(O)})},we=function(f){var T;for(let P of f)if(P.type==="attributes"){let{target:R,attributeName:k}=P,O=r(this,g).get(R);O&&k&&(O.setAttribute(k,(T=R.getAttribute(k))!=null?T:""),y(this,S,fe).call(this,O))}},fe=function(f){f&&f.localName==="track"&&f.default&&(f.kind==="chapters"||f.kind==="metadata")&&f.track.mode==="disabled"&&(f.track.mode="hidden")},xe=function(f){if(Object.prototype.hasOwnProperty.call(this,f)){let T=this[f];delete this[f],this[f]=T}},Ne=function(f,T,P){var R,k,O;["id","class"].includes(f)||!d.observedAttributes.includes(f)&&this.constructor.observedAttributes.includes(f)||(P===null?(R=this.nativeEl)==null||R.removeAttribute(f):((k=this.nativeEl)==null?void 0:k.getAttribute(f))!==P&&((O=this.nativeEl)==null||O.setAttribute(f,P)))},l(d,x),E(d,"getTemplateHTML",i.endsWith("audio")?Si:Ri),E(d,"shadowRootOptions",{mode:"open"}),E(d,"Events",me),l(d,b,!1),d}function Ci(e){let i=[];for(let t=Object.getPrototypeOf(e);t&&t!==HTMLElement.prototype;t=Object.getPrototypeOf(t)){let s=Object.getOwnPropertyNames(t);i.push(...s)}return i}function Ve(e){let i="";for(let t in e){if(!Le.includes(t))continue;let s=e[t];s===""?i+=` ${t}`:i+=` ${t}="${s}"`}return i}function _i(e){let i={};for(let t of e)i[t.name]=t.value;return i}var Pe,Xt=De((Pe=globalThis.HTMLElement)!=null?Pe:class{},{tag:"video"}),Oe,Yi=De((Oe=globalThis.HTMLElement)!=null?Oe:class{},{tag:"audio"});var V=new WeakMap,Tt=class extends Error{},Jt=class extends Error{};var Ii=["application/x-mpegURL","application/vnd.apple.mpegurl","audio/mpegurl"],Ge=globalThis.WeakRef?class extends Set{add(e){super.add(new WeakRef(e))}forEach(e){super.forEach(i=>{let t=i.deref();t&&e(t)})}}:Set;function Fe(e){var i,t,s;(t=(i=globalThis.chrome)==null?void 0:i.cast)!=null&&t.isAvailable?(s=globalThis.cast)!=null&&s.framework?e():customElements.whenDefined("google-cast-button").then(e):globalThis.__onGCastApiAvailable=()=>{customElements.whenDefined("google-cast-button").then(e)}}function Be(){return globalThis.chrome}function Ke(){var t;let e="https://www.gstatic.com/cv/js/sender/v1/cast_sender.js?loadCastFramework=1";if((t=globalThis.chrome)!=null&&t.cast||document.querySelector(`script[src="${e}"]`))return;let i=document.createElement("script");i.src=e,document.head.append(i)}function G(){var e,i;return(i=(e=globalThis.cast)==null?void 0:e.framework)==null?void 0:i.CastContext.getInstance()}function xt(){var e;return(e=G())==null?void 0:e.getCurrentSession()}function Zt(){var e;return(e=xt())==null?void 0:e.getSessionObj().media[0]}function qe(e){return new Promise((i,t)=>{Zt().editTracksInfo(e,i,t)})}function Ue(e){return new Promise((i,t)=>{Zt().getStatus(e,i,t)})}function pe(e){return G().setOptions({...ge(),...e})}function ge(){return{receiverApplicationId:"CC1AD845",autoJoinPolicy:"origin_scoped",androidReceiverCompatible:!1,language:"en-US",resumeSavedSession:!0}}function Pi(e){if(!e)return;let i=/\.([a-zA-Z0-9]+)(?:\?.*)?$/,t=e.match(i);return t?t[1]:null}function Oi(e){let i=e.split(`
